...
var _fxCSS=document.getElementById('fx-cursor-styles');
if(!_fxCSS){_fxCSS=document.createElement('style');_fxCSS.id='fx-cursor-styles';
_fxCSS.textContent='.fx-cursor-dot{position:fixed;top:0;left:0;width:6px;height:6px;background:var(--text-primary,#fff);border-radius:50%;pointer-events:none;z-index:99999;mix-blend-mode:difference;transition:width .25s,height .25s,background .25s,margin .25s}.fx-cursor-dot.fx-cursor-hover{width:20px;height:20px;margin-top:-7px;margin-left:-7px;background:var(--fx-gold,#ff8c00);mix-blend-mode:normal;box-shadow:0 0 18px rgba(255,140,0,.7)}.fx-cursor-ring{position:fixed;top:0;left:0;width:38px;height:38px;border:1.5px solid rgba(255,255,255,.45);border-radius:50%;pointer-events:none;z-index:99998;mix-blend-mode:difference;transition:width .25s,height .25s,border-color .25s,margin .25s}.fx-cursor-ring.fx-cursor-hover{width:48px;height:48px;margin-top:-5px;margin-left:-5px;border-color:var(--fx-gold,#ff8c00);mix-blend-mode:normal}.fx-cursor-trail{position:fixed;top:0;left:0;width:90px;height:90px;border-radius:50%;pointer-events:none;z-index:99997;background:radial-gradient(circle,rgba(255,0,110,.08) 0%,rgba(255,140,0,.04) 40%,transparent 70%)}';
document.head.appendChild(_fxCSS);}
var _fxCSS2=document.getElementById('fx-effects-styles');
if(!_fxCSS2){_fxCSS2=document.createElement('style');_fxCSS2.id='fx-effects-styles';
_fxCSS2.textContent='#pc{position:fixed;inset:0;z-index:0;pointer-events:none}' +
'.fx-marquee-wrap{width:100%;overflow:hidden;white-space:nowrap;padding:12px 0;position:relative;z-index:1;border-top:1px solid rgba(255,255,255,0.06);border-bottom:1px solid rgba(255,255,255,0.06);background:rgba(255,255,255,0.015)}' +
'.fx-marquee-track{display:inline-flex;gap:48px;animation:marqueeScroll 22s linear infinite!important;will-change:transform;transform:translateZ(0)}' +
'.fx-marquee-item{font-size:.8rem;text-transform:uppercase;letter-spacing:3px;font-weight:700;color:rgba(255,255,255,.6);white-space:nowrap;display:inline-flex;align-items:center;gap:48px}' +
'@keyframes marqueeScroll{from{transform:translate3d(0,0,0)}to{transform:translate3d(-50%,0,0)}}';
document.head.appendChild(_fxCSS2);}
