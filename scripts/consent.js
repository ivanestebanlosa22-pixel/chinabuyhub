(function() {
  ...
  function showBanner() {
    ...
    banner.innerHTML =
      ...
      '<span style="flex:1;min-width:220px">We use cookies to improve your experience and show personalized ads. <a href="/legal.html" style="color:#fff;text-decoration:underline">Privacy Policy</a></span>' +
      ...
      '<button id="consent-accept" style="background:#b81c2b;color:#fff;border:none;padding:8px 18px;border-radius:4px;cursor:pointer;font-size:13px;font-weight:bold">Accept All</button>' +
      '</div></div>';
